...
type ProjectProps = {
    title:string,image:string,url:string,skills:string[],description:string
    }
...
const Projects = () => {
    ...
    return (
        ...
        <div className='grid sm:grid-cols-2 grid-cols-1 lg:grid-cols-3 gap-4 w-full place-items-center min-h-screen'>
            {
...
function Project({title,image,url,skills,description}:ProjectProps) {
    return(
    <Card className="w-[350px] sm:w-[400px] border-2 border-stone-500">
      ...
      <CardFooter>
        ...
        <Link href={url}><Button variant={'link'}>link</Button></Link>
      </CardFooter>
    </Card>)
}